...
var Re = Math.clz32 ? Math.clz32 : Uc,
  Fc = Math.log,
  jc = Math.LN2;
function Uc(e) {
...
function It(e) {
  ...
  for (; 0 < qe.length && ((t = qe[0]), t.blockedOn === null); )
    zs(t), t.blockedOn === null && qe.shift();
}
...
var Fr = null;
function su(e, n, t, r) {
  if (((Fr = null), (e = Ku(r)), (e = kn(e)), e !== null))
...
function wf(e, n) {
  if (In)
    return e === "compositionend" || (!eo && Os(e, n))
...
function Cf(e, n, t) {
  e === "focusin"
    ? (ni(), (_t = n), (Ft = t), _t.attachEvent("onpropertychange", Fs))
    : e === "focusout" && ni();
}
function _f(e) {
...
var Lf = We && "documentMode" in document && 11 >= document.documentMode,
  Fn = null,
  au = null,
  xt = null,
  cu = !1;
...
var As = rl("animationend"),
  Vs = rl("animationiteration"),
  Bs = rl("animationstart"),
  Hs = rl("transitionend"),
  Ws = new Map(),
  ui =
...
var kt =
  ...
  Of = new Set("cancel close invalid load scroll toggle".split(" ").concat(kt));
function oi(e, n, t) {
...
function Qs(e, n) {
  ...
  if (Or) throw ((e = uu), (Or = !1), (uu = null), e);
}
function D(e, n) {
  var t = n[vu];
  ...
  if (!e[ar]) {
    (e[ar] = !0),
      bi.forEach(function (t) {
        t !== "selectionchange" && (Of.has(t) || Ol(t, !1, e), Ol(t, !0, e));
      });
...
function vn() {
  if (!Il && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), ws(Yu, vn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function la(e, n) {
  ...
  if (
    ...
    (r = r.queue),
    yo(ia.bind(null, t, r, e), [e]),
    r.getSnapshot !== n || u || (G !== null && G.memoizedState.tag & 1))
  ) {
    if (
      ((t.flags |= 2048),
      Qt(9, oa.bind(null, t, r, l, n), void 0, null),
      Z === null)
    )
      throw Error(y(349));
    Nn & 30 || ua(t, n, l);
...
function ma(e, n, t) {
  return (
    (t = t != null ? t.concat([e]) : null), ol(4, 4, pa.bind(null, n, e), t)
  );
}
function go() {}
function va(e, n) {
...
function ya(e, n, t) {
  return Nn & 21
    ? (Me(t, n) || ((t = Es()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function Qf(e, n, t) {
  ...
  if (wa(e)) ka(n, l);
    ...
    (t = ea(e, n, l, r)),
      t !== null && ((l = ue()), Oe(t, e, r, l), Sa(t, n, r));
  }
}
function wa(e) {
  var n = e.alternate;
  ...
  Kf = {
    ...
    useImperativeHandle: function (e, n, t) {
      return (
        ...
        _r(4194308, 4, pa.bind(null, n, e), t)
      );
    },
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        (l.queue = u),
        wi(ia.bind(null, r, u, e), [e]),
        (r.flags |= 2048),
        Qt(9, oa.bind(null, r, u, t, n), void 0, null),
        t
      );
    },
    useId: function () {
...
function Ni(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    xr(e, n), Ea(n, t, r), Su(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function Jf(e, n, t, r, l, u, o) {
  ...
  if (((i = (o & e.childLanes) !== 0), ae || i)) {
    ...
    return xo(), (r = Al(Error(y(421)))), pr(e, n, o, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
...
function td(e, n) {
  ...
  for (du = { focusedElem: e, selectionRange: t }, Ir = !1, S = n; S !== null; )
...
function Da(e) {
  ...
  n !== null && ((e.alternate = null), Da(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[At], delete n[vu], delete n[Uf], delete n[$f])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Wo(t), n === 1))
      e.tag === 0 ? Af(Fi.bind(null, e)) : Xs(Fi.bind(null, e)),
        Ff(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
function zr(e, n, t, r, l, u) {
  ...
  if (((r = e), typeof e == "function")) Po(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Ql:
        return (
          (e = Ee(12, t, n, l | 2)), (e.elementType = Ql), (e.lanes = u), e
        );
      case Kl:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Xu(n, t | 1), de(n, W()), !(R & 6) && ((rt = W() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
ps = Co;
ms = Ln;
var gd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, fs, ds, Co] },
  ht = {
...
const Sd = Ja(document.getElementById("root"));
function Ed({ onNewBook: e }) {
  const [n, t] = we.useState("");
  function r(l) {
    l.preventDefault(), e({ title: n }), t("");
  }
  return we.createElement(
    ...
    we.createElement("button", null, "Add"),
  );
}
function Cd() {
  const [e, n] = Lr.useState([]);
  async function t() {
    const l = await fetch("/api/books");
    l.ok ? n(await l.json()) : console.log("error occured");
  }
  Lr.useEffect(() => {
    t();
  }, []);
  ...
  return we.createElement(
    we.Fragment,
    null,
    we.createElement("h1", null, "Books I want to read"),
    e.map((l, u) =>
      we.createElement(
        "div",
        { key: u },
        we.createElement("input", { type: "checkbox" }),
        l.title,
      ),
    ),
    we.createElement(Ed, { onNewBook: r }),
  );
}
Sd.render(we.createElement(Cd, null));
